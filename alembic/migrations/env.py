...
from src.config import HOST, POSTGRES_DB, POSTGRES_USER, POSTGRES_PASSWORD, PORT
...
from src.accounting.models import Base
target_metadata = [User.metadata, Base.metadata]
